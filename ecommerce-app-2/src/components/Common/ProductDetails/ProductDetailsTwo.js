    ...
    useEffect(() => {
        const getProduct = async () => {
            await axiosInstance.get("products/" + productId).then(response => {            
                setProductFromDB(response.data.result)
            })
            .catch(error => {
                                ...
                                <Slider {...settings}>
                                    {
                                        <div className="product_img_two_slider">
                                            <img src={imageUrl + productFromDB.imageUrl} alt="img" />
                                        </div>
                                    }
                                </Slider>
                            </div>
                        ...
                        <div className="col-lg-8">
                            <div className="product_details_right_one">
                                <div className="modal_product_content_one">
                                    ...
                                    <h4>{productFromDB.price}.00 TL <del>{parseInt(product.price) + 17}.00 TL</del> </h4>
